//
//  PaymentPickerSheetViewController.swift
//  Cloverly
//
...
class PaymentPickerSheetViewController: UIViewController {
    ...
    private lazy var confirmButton: UIButton = {
        ...
        btn.addAction(UIAction { [weak self] _ in
            ...
            onSelect?(payments[indexPath.item])
...
extension PaymentPickerSheetViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.configure(text: payments[indexPath.item].displayName)
        return cell
    }
